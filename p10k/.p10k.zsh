# Generated by Powerlevel10k configuration wizard on 2020-07-30 at 18:18 CST.
...
() {
  ...
  # Add an empty line before each prompt (sparse | compact).
  ...
  function my_git_formatter() {
    ...
    res+="${meta}) ${VCS_STATUS_COMMIT[1,7]}"
