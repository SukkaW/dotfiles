...
sudo tmutil addexclusion -p "${HOME}/.arcbox/logs"
sudo tmutil addexclusion -p "${HOME}/.bytertc"
sudo tmutil addexclusion -p "${HOME}/.EventSDK"
sudo tmutil addexclusion -p "${HOME}/.electron-gyp"
sudo tmutil addexclusion -p "${HOME}/.dropbox"
sudo tmutil addexclusion -p "${HOME}/.degit"
sudo tmutil addexclusion -p "${HOME}/Dropbox"
sudo tmutil addexclusion -p "${HOME}/Nutstore Files"
sudo tmutil addexclusion -p "${HOME}/NutstoreCloudBridge"
...
sudo tmutil addexclusion -p "${HOME}/.codex/tmp"
sudo tmutil addexclusion -p "${HOME}/.codex/cache"
sudo tmutil addexclusion -p "${HOME}/.codex/plugins/cache"
...
sudo tmutil addexclusion -p "${HOME}/.copilot/logs"
sudo tmutil addexclusion -p "${HOME}/.claude/projects/"
sudo tmutil addexclusion -p "${HOME}/.claude/file-history/"
sudo tmutil addexclusion -p "${HOME}/.claude/plugins/cache/"
sudo tmutil addexclusion -p "${HOME}/.claude/cache/"
sudo tmutil addexclusion -p "${HOME}/.claude/telemetry/"
...
sudo tmutil addexclusion -p "${HOME}/.orbstack/log/"
sudo tmutil addexclusion -p "${HOME}/.bun/"
sudo tmutil addexclusion -p "${HOME}/.nvm/"
sudo tmutil addexclusion -p "${HOME}/.local/share/fnm/"
sudo tmutil addexclusion -p "${HOME}/.local/share/mise/"
...
sudo tmutil addexclusion -p "${HOME}/.vite-plus/"
...
sudo tmutil addexclusion -p "${HOME}/.vibe-island/"
...
sudo tmutil addexclusion -p "${HOME}/.snipaste/splog.txt"
sudo tmutil addexclusion -p "${HOME}/.snipaste/splog.1.txt"
...
sudo tmutil addexclusion -p "${HOME}/Library/Application Support/Code/User/workspaceStorage/"
...
sudo tmutil addexclusion -p "${HOME}/Library/Application Support/zoom.us/AutoUpdater/"
...
sudo tmutil addexclusion -p "${HOME}/Library/Application Support/Garmin/Express/Firmware/"
...
sudo tmutil addexclusion -p "/Applications/LarkSuite.app"
